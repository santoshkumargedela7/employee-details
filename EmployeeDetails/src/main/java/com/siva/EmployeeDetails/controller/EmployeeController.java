...
public class EmployeeController {
	...
	public ResponseEntity<Employee> getById(@PathVariable("id")Long id){
		...
		logger.info("employeeDetails of id :"+employees);
	...
	//	List<Employee> employee = employeeService.getAllEmployees();
	  ...
	  List<String> names =
	  employeeService.getAllEmployees().stream().map(emp->emp.getFirstName())
	  .collect(Collectors.toList()); System.out.println(names);
	  
	  List<Integer> ages = employeeService.getAllEmployees().stream().
