...
import com.siva.EmployeeDetails.entity.EmployeeData;
...
//	public EmployeeDto convertEntityToDto(Employee employee, EmployeeData data) {
//
//		EmployeeDto employeeDto = modelMapper.map(employee, EmployeeDto.class);
//		 EmployeeDataDto employeeDataDto =
//		 modelMapper.map(data,EmployeeDataDto.class);
//
